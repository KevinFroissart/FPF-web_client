				...
				return this.each(function () {
					...
					if (settings.options.sniffHtml) {
						...
						if ($this.attr('pattern') !== undefined) {
							message =
								'Mauvais format<!-- data-validation-pattern-message to override -->';
						...
						if (
							...
							message =
								'Trop fort: ' +
								max +
								' maximum<!-- data-validation-max-message to override -->';
						...
						if (
							...
							message =
								'Trop faible: ' +
								min +
								' minimum<!-- data-validation-min-message to override -->';
						...
						if ($this.attr('maxlength') !== undefined) {
							message =
								'Trop long: ' +
								$this.attr('maxlength') +
								' caractères maximum<!-- data-validation-maxlength-message to override -->';
						...
						if ($this.attr('minlength') !== undefined) {
							message =
								'Trop court: ' +
								$this.attr('minlength') +
								' caractères minimum<!-- data-validation-minlength-message to override -->';
						...
						if (
							...
							message =
								'Adresse mail invalide<!-- data-validator-validemail-message to override -->';
						...
						if ($this.attr('minchecked') !== undefined) {
							message =
								"Pas suffisament d'options choisies; " +
								$this.attr('minchecked') +
								' minimum requises<!-- data-validation-minchecked-message to override -->';
						...
						if ($this.attr('maxchecked') !== undefined) {
							message =
								...
								' maximum requises<!-- data-validation-maxchecked-message to override -->';
